        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssetTypeName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssetDefinitionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssetDefinitions", x => x.AssetDefinitionId);
                    table.ForeignKey(
                        name: "FK_AssetDefinitions_AssetTypes_AssetTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_AssetDefinitions_AssetDefinitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssetCreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "AssetTypes",
                columns: new[] { "AssetTypeId", "AssetTypeName", "Description", "IsActive" },
                values: new object[,]
                {
                    { 1, "Laptop", "Laptop Devices", true },
                    { 2, "Mobile", "Mobile Devices", true },
                    { 3, "Printer", "Printer Devices", true }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetDefinitions_AssetTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_AssetDefinitionId",
